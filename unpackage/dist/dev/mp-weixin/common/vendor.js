...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.3.17",\n        "192.168.3.1",\n        "192.168.88.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/Users/86135/Downloads/HBuilderX.4.29.2024093009/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"live-agent","spaceId":"mp-797aa145-91b6-4b18-a885-d123f5829b6e","clientSecret":"6oeJDj3b21nJHOPk6F75vQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__D091391";
} catch (e2) {

...
(() => {
  ...
  // ../../../直播助手项目/LiveAgent/live_agent/alive-front/unpackage/dist/dev/.nvue/pages/list/search/search.js
  var import_vue = __toESM(require_vue());

  // ../../../直播助手项目/LiveAgent/live_agent/alive-front/unpackage/dist/dev/.nvue/_plugin-vue_export-helper.js
  ...
  var b = true;
  var E = "app";
  var P = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default);
  var C = E;
  var A = T('{"address":["127.0.0.1","192.168.199.1","192.168.217.1","192.168.5.32"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/dachuang/HbuilderX/HBuilderX/plugins/unicloud/**/*.js"]}');
  var O = T('[{"provider":"aliyun","spaceName":"live-agent","spaceId":"mp-2f9390ec-7ecb-48a2-9e47-e99a53037e27","clientSecret":"V0qIAEe36jSG4uDyjnH33w==","endpoint":"https://api.next.bspapp.com"}]') || [];
  var N = "";
  try {
    N = "__UNI__D091391";
  } catch (e2) {
  ...
  var ut = class extends st {
    signIn(e2, t2) {
      return __async(this, null, function* () {
        ...
        const { refreshTokenKey: n2 } = this._cache.keys, s2 = yield this._request.send("auth.signIn", { loginType: ze.USERNAME, username: e2, password: t2, refresh_token: this._cache.getStore(n2) || "" }), { refresh_token: r2, access_token_expire: i2, access_token: o2 } = s2;
        if (r2)
  ...
  var ft = function({ fileList: e2 }, t2) {
  ...
  var mt = function({ name: e2, data: t2, query: n2, parse: s2, search: r2, timeout: i2 }, o2) {
    const a2 = o2 || Ie();
    let c2;
    try {
  ...
  var vt = class _vt {
    ...
    init(e2) {
      switch (Ce.adapter || (this.requestClient = new Ce.adapter.reqClass({ timeout: e2.timeout || 5e3, timeoutMsg: `\u8BF7\u6C42\u5728${(e2.timeout || 5e3) / 1e3}s\u5185\u672A\u5B8C\u6210\uFF0C\u5DF2\u4E2D\u65AD` })), this.config = __spreadValues(__spreadValues({}, yt), e2), true) {
  ...
  var Nt = class {
    ...
    setupLocalRequest(e2) {
      return __async(this, null, function* () {
        const t2 = le(), { token: n2 } = re(), s2 = Object.assign({}, e2, { spaceId: this.config.spaceId, timestamp: Date.now(), clientInfo: t2, token: n2 }), { address: r2, servePort: i2 } = this.__dev__ && this.__dev__.debugInfo || {}, { address: o2 } = yield Ot(r2, i2);
...
`, c3 = ve(a3, e3.secretKey).toString(Lt);
  ...
  var $t = class {
    ...
    uploadFile(_0) {
      return __async(this, arguments, function* ({ filePath: e2, cloudPath: t2 = "", fileType: n2 = "image", onUploadProgress: s2 }) {
        ...
        if (/:\/\//.test(t2))
          throw new te({ code: "INVALID_PARAM", message: "cloudPath\u4E0D\u5408\u6CD5" });
        const r2 = yield qt({ path: "/".concat(t2.replace(/^\//, ""), "?post_url") }, this.config), { file_id: i2, upload_url: o2, form_data: a2 } = r2, c2 = a2 && a2.reduce((e3, t3) => (e3[t3.key] = t3.value, e3), {});
  ...
  var Un = "uni-secure-network";
  var Dn = { SYSTEM_ERROR: { code: 2e4, message: "System error" }, APP_INFO_INVALID: { code: 20101, message: "Invalid client" }, GET_ENCRYPT_KEY_FAILED: { code: 20102, message: "Get encrypt key failed" } };
  function qn(e2) {
...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), (console["warn" === t4 ? "error" : t4] || console.log)(r3);
  ...
  var ws = !!e.uniIdRouter;
  var { loginPage: vs, routerNeedLogin: Is, resToLogin: Ss, needLoginPage: Ts, notNeedLoginPage: bs, loginPageInTabBar: Es } = function({ pages: t2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = e) {
  ...
  var Ds = /^(?:[A-Za-z\d+/]{4})*?(?:[A-Za-z\d+/]{2}(?:==)?|[A-Za-z\d+/]{3}=?)?$/;
  function Ms() {
  ...
  var Fs = t$2(qs);
  var Ks = { auto: "auto", onready: "onready", manual: "manual" };
  function js(e2) {
        ...
        return function({ fn: e3, interceptorName: t3, getCallbackArgs: n3 } = {}) {
          ...
          return __async(this, null, function* () {
            ...
            if (a2 && uni.hideLoading(), y2 && y2.token && y2.tokenExpired && (ie(y2), Y(H.REFRESH_TOKEN, __spreadValues({}, y2))), g2) {
              let e3 = m2;
              if (p2 && o2) {
                e3 = (yield o2({ objectName: t2, methodName: c2, params: u2, errSubject: f2, errCode: g2, errMsg: m2 })).errMsg || m2;
              }
              if (a2)
                if ("toast" === i2.type)
  ...
  function Ys(e2) {
    return __async(this, null, function* () {
      ...
      if (!t2.debugInfo)
        return;
      const { address: n2, servePort: s2 } = t2.debugInfo, { address: r2 } = yield Ot(n2, s2);
      if (r2)
  ...
  var Xs = { tcb: Ct, tencent: Ct, aliyun: fe, private: Rt, dcloud: Rt, alipay: Bt };
  var Zs = new class {
    init(e2) {
      let t2 = {};
  ...
  var __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["styles", [_style_0$5]], ["__file", "D:/dachuang/HbuilderX/\u76F4\u64AD\u52A9\u624B\u9879\u76EE/LiveAgent/live_agent/alive-front/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  var __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["styles", [_style_0$4]], ["__file", "D:/dachuang/HbuilderX/\u76F4\u64AD\u52A9\u624B\u9879\u76EE/LiveAgent/live_agent/alive-front/uni_modules/uni-search-bar/components/uni-search-bar/uni-search-bar.vue"]]);
  var en = {
  ...
  var __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__file", "D:/dachuang/HbuilderX/HBuilderX/plugins/uniapp-cli-vite/node_modules/@dcloudio/uni-components/lib/unicloud-db/unicloud-db.vue"]]);
  ...
  var __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["styles", [_style_0$3]], ["__file", "D:/dachuang/HbuilderX/\u76F4\u64AD\u52A9\u624B\u9879\u76EE/LiveAgent/live_agent/alive-front/uni_modules/uni-badge/components/uni-badge/uni-badge.vue"]]);
  ...
  var __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["styles", [_style_0$2]], ["__file", "D:/dachuang/HbuilderX/\u76F4\u64AD\u52A9\u624B\u9879\u76EE/LiveAgent/live_agent/alive-front/uni_modules/uni-list/components/uni-list-item/uni-list-item.vue"]]);
  ...
  var __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0$1]], ["__file", "D:/dachuang/HbuilderX/\u76F4\u64AD\u52A9\u624B\u9879\u76EE/LiveAgent/live_agent/alive-front/uni_modules/uni-list/components/uni-list/uni-list.vue"]]);
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_icons = resolveEasycom((0, import_vue.resolveDynamicComponent)("uni-icons"), __easycom_0);
    const _component_uni_search_bar = resolveEasycom((0, import_vue.resolveDynamicComponent)("uni-search-bar"), __easycom_1$1);
    const _component_unicloud_db = resolveEasycom((0, import_vue.resolveDynamicComponent)("unicloud-db"), __easycom_2);
    const _component_uni_list_item = resolveEasycom((0, import_vue.resolveDynamicComponent)("uni-list-item"), __easycom_3);
    const _component_uni_list = resolveEasycom((0, import_vue.resolveDynamicComponent)("uni-list"), __easycom_4);
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("scroll-view", {
      ...
      (0, import_vue.createElementVNode)("view", { class: "container" }, [
        (0, import_vue.createElementVNode)("view", { class: "search-container" }, [
          (0, import_vue.createCommentVNode)(" \u641C\u7D22\u6846 "),
          (0, import_vue.createElementVNode)("view", { class: "search-container-bar" }, [
            (0, import_vue.createVNode)(_component_uni_icons, {
              class: "search-icons",
            ...
            (0, import_vue.createCommentVNode)(` :cancelText="keyBoardPopup ? '\u53D6\u6D88' : '\u641C\u7D22'" `),
            (0, import_vue.createVNode)(_component_uni_search_bar, {
              ref: "searchBar",
              style: { "flex": "1" },
              radius: "100",
        ...
        (0, import_vue.createElementVNode)("view", { class: "search-body" }, [
          (0, import_vue.createCommentVNode)(" \u641C\u7D22\u5386\u53F2 "),
          $data.localSearchList.length ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
            key: 0,
            class: "word-container"
          }, [
            (0, import_vue.createElementVNode)("view", { class: "word-container_header" }, [
              (0, import_vue.createElementVNode)("u-text", { class: "word-container_header-text" }, "\u641C\u7D22\u5386\u53F2"),
              !$data.localSearchListDel ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_uni_icons, {
                key: 0,
                ...
                size: "18",
                type: "trash"
              }, null, 8, ["color"])) : ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                key: 1,
            ...
            (0, import_vue.createElementVNode)("view", { class: "word-container_body" }, [
              ((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
                import_vue.Fragment,
                null,
                (0, import_vue.renderList)($data.localSearchList, (word, index) => {
                  return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    ...
                    ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
                      ...
                      (0, import_vue.toDisplayString)(word),
                      1
                      /* TEXT */
                    )),
                    $data.localSearchListDel ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_uni_icons, {
          ...
          (0, import_vue.createCommentVNode)(" \u641C\u7D22\u53D1\u73B0 "),
          (0, import_vue.createElementVNode)("view", { class: "word-container" }, [
            (0, import_vue.createElementVNode)("view", { class: "word-container_header" }, [
              (0, import_vue.createElementVNode)("view", { class: "flex-center flex-row" }, [
                (0, import_vue.createElementVNode)("u-text", { class: "word-container_header-text" }, "\u641C\u7D22\u53D1\u73B0"),
                !$data.netHotListIsHide ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_uni_icons, {
                  key: 0,
                  class: "search-icons",
                  color: $data.iconColor,
                  size: "14",
                ...
                }, null, 8, ["color", "onClick"])) : (0, import_vue.createCommentVNode)("v-if", true)
              ]),
              (0, import_vue.createVNode)(_component_uni_icons, {
                class: "search-icons",
                style: { "padding-right": "0" },
            ...
            (0, import_vue.createVNode)(
              ...
              },
              {
                default: (0, import_vue.withCtx)(({ data, loading, error, options }) => [
                  loading && !$data.netHotListIsHide ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("u-text", {
                    key: 0,
                    class: "word-container_body-info"
                  }, "\u6B63\u5728\u52A0\u8F7D...")) : ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 1,
                    class: "word-container_body"
                  }, [
                    !$data.netHotListIsHide ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
                      import_vue.Fragment,
                      { key: 0 },
                      [
                        error ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
                          "u-text",
                          {
                            key: 0,
                            class: "word-container_body-info"
                          ...
                          import_vue.Fragment,
                          { key: 1 },
                          (0, import_vue.renderList)(data, (word, index) => {
                            ...
                            }, (0, import_vue.toDisplayString)(word.content), 9, ["onClick"]);
                          }),
                          128
                          /* KEYED_FRAGMENT */
                        ))
                      ...
                      (0, import_vue.createElementVNode)("u-text", { class: "word-container_body-info" }, "\u5F53\u524D\u641C\u7D22\u53D1\u73B0\u5DF2\u9690\u85CF")
                    ]))
                  ]))
                ]),
                _: 1
        ...
        (0, import_vue.createCommentVNode)(" \u641C\u7D22\u8054\u60F3 "),
        $options.associativeShow ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
          key: 0,
          class: "search-associative"
        }, [
          (0, import_vue.createVNode)(_component_uni_list, null, {
            default: (0, import_vue.withCtx)(() => [
              ((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
                import_vue.Fragment,
                null,
                (0, import_vue.renderList)($data.associativeList, (item, index) => {
  ...
  var search = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "D:/dachuang/HbuilderX/\u76F4\u64AD\u52A9\u624B\u9879\u76EE/LiveAgent/live_agent/alive-front/pages/list/search/search.nvue"]]);
